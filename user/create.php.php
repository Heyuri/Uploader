...
if($pass2 !== $admin) error('Incorrect password.');
...
Pass: <INPUT TYPE=password SIZE="10" NAME="pass2" maxlength="25"><br>COMMENT<i><small>（※If no comment is entered, the page will be reloaded / URL will be auto-linked.）</small></i><br>
